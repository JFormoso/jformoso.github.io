...
resultado_piloto <- powerSim(modelo, test = prueba_interaccion, nsim = 100)
resultado_piloto
...
```{r}
modelo_extendido_estudiante <- extend(modelo, along = "estudiante", n = 192)  # 32 por comisión, 6 comisiones
...
# Poder puntual para esta configuracion (144 estudiantes en total)
prueba_interaccion <- fixed("metodoespaciada:numero_examen", "z")
...
Además, agradezco a mi directora de posdoc y carrera, [Débora Burín](https://www.linkedin.com/in/d-i-burin-644ba52/), que me contagió el amor por los análisis reproducibles y que se sentó varias veces y con muchísima paciencia a interpretar líneas de código y explicarme cómo hacer estos cálculos.  
